...
| Module | Description |
|--------|-------------|
| **Zevent** | Zevent charity marathon tracker — amount raised, streamer status, planning, milestones, optional Discord server event. Follows the current edition automatically. *(disabled by default)* |
